...
#define PHY_INT_EXTI_XGPIOCAT(y) 	 LL_SYSCFG_EXTI_PORT##y
#define PHY_INT_EXTI_LINENUM(x) 	 PHY_INT_EXTI_CAT(LL_EXTI_LINE_ , x)
#define PHY_INT_EXTI_PORT_SOURCE(x)  PHY_INT_EXTI_XGPIOCAT(x)
#define PHY_INT_EXTI_PIN_SOURCE(x)   PHY_INT_EXTI_CAT(LL_SYSCFG_EXTI_LINE, x)
